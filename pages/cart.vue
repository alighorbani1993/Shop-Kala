    ...
    <div class="col-xl-9 col-lg-8">
      ...
      <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          <button
            class="nav-link fs-6 fw-bold active"
            id="nav-1-tab"
            data-bs-toggle="tab"
              ...
              <div class="cart-items">
                ...
                <div class="cart-item">
                  <div class="cart-item--thumbnail">
                    <a href="#">
                      <img src="/images/carts/01.jpg" alt="" />
                    </a>
                  </div>
                ...
                <div class="cart-item">
                  <div class="cart-item--thumbnail">
                    <a href="#">
                      <img src="/images/carts/02.jpg" alt="" />
                    </a>
                  </div>
                  <div class="cart-item--detail">
                    <h2 class="cart-item--title mb-2">
                      <a href="#"
                        >گوشی موبایل اپل مدل iPhone 13 A2634 دو سیم‌ کارت ظرفیت 128
                ...
                <div class="cart-item">
                  <div class="cart-item--thumbnail">
                    <a href="#">
                      <img src="/images/carts/03.jpg" alt="" />
                    </a>
                  </div>
                  <div class="cart-item--detail">
                    <h2 class="cart-item--title mb-2">
                      <a href="#">
                        دوربین دیجیتال کانن مدل EOS 4000D به همراه لنز 18-55 میلی متر DC
                        III</a
                      >
                    </h2>
                    <div class="cart-item--variant mb-2">
        ...
        <div class="checkout-bill ui-box bg-white mb-5">
          <div class="checkout-bill-row">
            ...
            <div class="checkout-bill-row-value">
              <span class="fs-6">۴۲,۴۲۰,۰۰۰</span> <span class="currency">تومان</span>
            </div>
          </div>
          <div class="checkout-bill-row">
          ...
          <div class="checkout-bill-row">
            ...
            <div class="checkout-bill-row-value">
              <span class="fs-6">۴۲,۴۱۵,۰۰۰</span> <span class="currency">تومان</span>
            </div>
          </div>
          <div class="checkout-bill-row checkout-bill-note">
            هزینه‌ی ارسال در ادامه بر اساس آدرس، زمان و نحوه‌ی ارسال انتخابی شما‌ محاسبه و
            به این مبلغ اضافه خواهد شد
          </div>
          ...
          <div class="checkout-bill-row checkout-bill-footer">
            ...
            <div class="checkout-bill-row-value">
              ۱۵۰ <span class="fs-7 fw-bold text-muted">امتیاز</span>
            </div>
          </div>
        </div>
