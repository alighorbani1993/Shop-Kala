  ...
  <div>
            ...
            <div class="product-gallery">
              <div class="product-options">
                <ul>
                  ...
                  <li>
                    <a href="#"><i class="ri-line-chart-fill"></i></a>
                  </li>
                  <li>
                    <a href="#"><i class="ri-scales-3-fill"></i></a>
                  </li>
                  <li>
                    <a href="#"><i class="ri-play-list-add-fill"></i></a>
                  </li>
                </ul>
              </div>
              <div class="gallery-img-container">
                <div class="gallery-img">
                  <img src="/images/gallery/main.jpg" class="zoom-img" alt="" />
                </div>
                <div class="gallery-thumbs">
                  <ul>
                    <li data-fancybox="gallery-a" data-src="/images/gallery/01.png">
                      <img src="/images/gallery/01.png" alt="" />
                    </li>
                    <li data-fancybox="gallery-a" data-src="/images/gallery/02.png">
                      <img src="/images/gallery/02.png" alt="" />
                    </li>
                    <li data-fancybox="gallery-a" data-src="/images/gallery/03.png">
                      <img src="/images/gallery/03.png" alt="" />
                    </li>
                    <li data-fancybox="gallery-a" data-src="/images/gallery/04.png">
        ...
        <div class="col-xl-5 col-lg-4 col-md-7 mb-lg-0 mb-4">
          ...
          <div class="product-user-suggestion mb-2">
            ...
            <span class="fs-7 me-2"
              >۷۹٪ (۱۷۰ نفر) از خریداران، این کالا را پیشنهاد کرده اند.</span
            >
            <span
          ...
          <div class="product-additional-info-container mb-3">
            ...
            <div class="product-additional-info">
              <p>
                ...
                نمایید. آموزش تصویری در آدرس اینترنتی hmti.ir/06
              </p>
              <p>
          ...
          <div class="widget p-0">
            <div class="widget-content widget--free-shipping">
              ...
              <div class="free-shipping--banner">
                <img
                  src="/images/theme/free-shipping--banner.png"
            ...
            <div class="seller-info-changeable">
              ...
              <div class="product-seller-row product-seller-row--clickable">
                ...
                <div class="product-seller-row-detail">
                  ...
                  <div class="product-seller-row-detail-subtitle">
                    <i></i> آماده ارسال
                  </div>
                </div>
              </div>
              ...
              <div class="product-seller-row product-remaining-in-stock">
                <span
                  >تنها <span class="mx-2">۱</span> عدد در انبار باقیست - پیش از اتمام
                  بخرید</span
                >
              </div>
            </div>
        ...
        <div class="suppliers-items">
          ...
          <div class="suppliers-item">
            ...
            <div class="suppliers-item-col suppliers-item-col--action">
              <a href="#" class="btn btn-sm btn-outline-primary fw-bold px-4"
                >افزودن به سبد</a
              >
            </div>
          </div>
            ...
            <div class="swiper-slide">
              ...
              <div class="product-card">
                ...
                <div class="product-card-body">
                  <h2 class="product-title">
                    <a href="#"
                      >گوشی موبایل اپل مدل iPhone 13 A2634 دو سیم‌ کارت ظرفیت 128 گیگابایت
                      و رم 4 گیگابایت</a
                    >
                  </h2>
            ...
            <div class="swiper-slide">
              ...
              <div class="product-card">
                ...
                <div class="product-card-body">
                  <h2 class="product-title">
                    <a href="#"
                      >گوشی موبایل شیائومی مدل 11 lite 5G NE 2109119DG دو سیم‌ کارت ظرفیت
                      256 گیگابایت و رم 8 گیگابایت</a
                    >
                  </h2>
                  <div class="product-variant">
            ...
            <div class="swiper-slide">
              ...
              <div class="product-card">
                ...
                <div class="product-card-body">
                  <h2 class="product-title">
                    <a href="#"
                      >گوشی موبایل شیائومی مدل Redmi Note 10 pro M2101K6G دو سیم‌ کارت
            ...
            <div class="swiper-slide">
              ...
              <div class="product-card">
                ...
                <div class="product-card-body">
                  <h2 class="product-title">
                    <a href="#"
                      >گوشی موبایل سامسونگ مدل Galaxy Z Flip3 5G ظرفیت 256 گیگابایت و رم 8
                      گیگابایت</a
                    >
                  </h2>
                  <div class="product-variant">
            ...
            <div class="swiper-slide">
              ...
              <div class="product-card">
                ...
                <div class="product-card-body">
                  <h2 class="product-title">
                    <a href="#"
                      >گوشی موبایل اپل مدل iPhone 12 Pro Max A2412 دو سیم‌ کارت ظرفیت 256
                      گیگابایت</a
                    >
                  </h2>
                  <div class="product-variant">
            ...
            <div class="swiper-slide">
              ...
              <div class="product-card">
                ...
                <div class="product-card-body">
                  <h2 class="product-title">
                    <a href="#"
                      >گوشی موبایل شیائومی مدل Mi 11i 5G M2012K11G دو سیم‌ کارت ظرفیت 256
                      گیگابایت و 8 گیگابایت رم</a
                    >
                  </h2>
                  <div class="product-variant">
                    <span class="color" style="background-color: #4d5b63"></span>
            ...
            <div class="swiper-slide">
              ...
              <div class="product-card">
                ...
                <div class="product-card-body">
                  <h2 class="product-title">
                    <a href="#"
                      >گوشی موبایل سامسونگ مدل Galaxy S9 Plus دو سیم کارت ظرفیت 64
                      گیگابایت</a
                    >
                  </h2>
                  <div class="product-variant">
            ...
            <div class="swiper-slide">
              ...
              <div class="product-card">
                ...
                <div class="product-card-body">
                  <h2 class="product-title">
                    <a href="#"
                      >گوشی موبایل سامسونگ مدل Galaxy Note 20 5G SM-N981B/DS دو سیم کارت
                      ظرفیت 256 گیگابایت و رم 8</a
                    >
                  </h2>
                  <div class="product-variant">
                    <span class="color" style="background-color: #24476e"></span>
    ...
    <div class="row">
      <div class="col-xl-9 col-lg-8">
        ...
        <div
          class="product-tab-content product-content-expert-summary tab-content border-bottom pb-2 mb-4"
          id="scrollspyHeading1"
        >
          <div class="product-tab-title">
            <h2>نقد و بررسی اجمالی</h2>
            <h3 class="subtitle">
              Apple iPhone 13 A2634 Dual SIM 128GB And 4GB RAM Mobile Phone
            </h3>
          </div>
          <div class="expandable-text pt-1" style="height: 250px">
            <div class="expandable-text_text">
              <p>
                گوشی موبایل «iPhone 13» پرچم‌دار جدید شرکت اپل است که با چند ویژگی جدید و
                دوربین دوگانه روانه بازار شده است. اپل برای ویژگی‌ها و طراحی کلی این گوشی
                از همان فرمول چند سال اخیرش استفاده کرده است. نمایشگر آیفون 13 به پنل
                Super Retina مجهز ‌شده است تا تصاویر بسیار مطلوبی را به کاربر عرضه کند.
                این نمایشگر رزولوشن بسیار بالایی دارد؛ به‌طوری‌که در اندازه­‌ی 6.1
                اینچی‌اش، حدود 460 پیکسل را در هر اینچ جا داده است. امکان شارژ بی‌‌سیم
                باتری در این گوشی وجود دارد. روکش سرامیکی صفحه‌نمایش این گوشی می‌تواند
                انقلابی در محافظت به‌پا کند. این گوشی ضدآب و ضد گردوخاک است. بدنه­ زیبا
                iPhone 13 در مقابل خط‌‌وخش مقاومت زیادی دارد؛ پس خیالتان از این بابت که آب
                و گردوغبار به‌‌راحتی روی آیفون 13 تأثیر نمی‌‌گذارد، راحت باشد. علاوه‌براین
                لکه و چربی هم روی این صفحه‌نمایش باکیفیت تأثیر چندانی ندارند. تشخیص چهره
                با استفاده از دوربین جلو دیگر ویژگی است که در آیفون جدید اپل به کار گرفته
                شده است. قابلیت اتصال به شبکه­‌های 4G و 5G، بلوتوث نسخه‌ 5، نسخه­‌ 15 از
                iOS دیگر ویژگی‌های این گوشی هستند. ازنظر سخت‌‌افزاری هم این گوشی از
                تراشه­‌ی جدید A15 بهره می‌برد که دارای 15 میلیارد ترانزیستور است که دارای
                کنترل گرمای مطلوبی بوده که تا بتواند علاوه بر کارهای معمول، از قابلیت‌های
                جدید واقعیت مجازی که اپل این روزها روی آن تمرکز خاصی دارد، پشتیبانی کند.
                به گفته خود شرکت اپل این گوشی دارای سرعتی 50 برابر نسخه 12 خود است.
                پردازنده دارای ماژولار جدیدی است که مصرف باتری را بسیار پایین‌تر آورده است
                و شما دارای حفظ باتری بالاتری هستید. کیفیت نمایش شما در iPhone 13 دارای
                120 هرتز است و کسفیت بالایی را شاهد خواهید بود. اپل در این سری از گوشی‌های
                iPhone خود پردازنده گرافیکی‌ای را قرار داده که از سری 12 گوشی‌های خود 30
                درصد سریع‌تر است و این نویدبخش آن است که شما می‌توانید بازی‌هایی را با
                گرافیک و MAP سنگین تر و بزرگ‌تر اجرا کنید. یکی از ویژگی‌هایی که در iPhone
                13 شاهد هستیم سیستم فیلمبرداری ProRes سینمایی آن است که می تواند انقلابی
                در فیلمبرداری گوشی‌های موبایل به‌راه انداخته باشد. این قابلیت می‌تواند
                نسبت به صورت روبرو بین افراد و یا بین فرد و اشیا فوکوس و بِلار داشته باشد.
              </p>
            </div>
        ...
        <div
          class="product-tab-content product-content-expert-articles tab-content border-bottom pb-2 mb-4"
        ...
        >
          ...
          <div class="expandable-text pt-1" style="height: 840px">
            <div class="expandable-text_text">
              ...
              <p>
                تا قبل از رونمایی گوشی‌های هوشمند خانواده آیفون 12، پرچمداران این شرکت در
                قالب دو یا سه گوشی‌هوشمند معرفی می‌شدند. تا اینکه آیفون 12 مینی نیز در
                کنار گوشی‌های هوشمند خانواده آیفون 12 معرفی شد. حال گوشی‌های هوشمند
                خانواده آیفون 13 به عنوان جدید‌ترین پرچمداران این شرکت روانه بازار شده‌اند
                و بار دیگر آیفون 13 مینی به عنوان کوچکترین عضو و البته ارزان قیمت‌ترین
                گوشی هوشمند خانواده آیفون 13 معرفی شد. اما قیمت ارزان تر این گوشی‌هوشمند
                به نسبت سایر اعضای این خانواده سبب نشده تا مشخصات قوی را با خود به‌همراه
                نداشته باشد و آیفون 13 مینی با بهره بردن از مشخصات فنی قدرتمند، توانایی
                رقابت با پرچمداران اندرویدی را به‌خوبی دارد.
              </p>
              <h3>طراحی و صفحه نمایش</h3>
              <p>
                در نگاه اول تفاوت چندانی در زمینه طراحی با سری قبلی پرچمداران این شرکت و
                به‌خصوص آیفون 12 مینی نمی‌بینیم. اپل با توجه به طراحی بسیار جذابی که برای
                گوشی‌های هوشمند خانواده آیفون 12 در نظر گرفته بود و بازخورد بسیار خوبی از
                سمت کاربران داشت، تصمیم گرفت تا طراحی مشابهی را برای گوشی‌های هوشمند
                خانواده آیفون 13 در نظر بگیرد. در نمای رو به رویی این بار ناچ کوچکتری به
                نسبت آیفون 12 مینی برای صفحه نمایش آیفون 13 مینی در نظر گرفته شده. در قسمت
                پشتی هم شاهد قرار گیری دو سنسور دوربین می‌باشیم که این بار چیدمان متفاوتی
                با نسل قبلی خود دارند. دو سنسور دوربین قسمت پشتی به همراه فلش LED با
                چیدمانی ضربدری در بریدگی مربعی شکلی کنار یکدیگر قرار گرفته‌اند. متریال
                بسیار با‌کیفیت این گوشی هوشمند نیز سبب شده تا از استاندارد IP68 نیز
                پشتیبانی کند. پس با این تفاسیر، آیفون 13 مینی توانایی قرار‌گیری در عمق 6
                متری آب و مدت زمان 30 دقیقه‌ای را دارد. پس با خیال راحت از این گوشی‌هوشمند
                در شرایط جوی متفاوت و حتی تفریحات آبی همچون شنا هم استفاده کنید.
              </p>
              <img src="/images/product/01.jpg" alt="" />
              <p>
                صفحه نمایش در نظر گرفته شده برای این گوشی‌هوشمند نیز هیچ تفاوتی با برادر
                بزرگترش، یعنی آیفون 12 ندارد و تنها از ابعاد کوچک‌تری بهره برده است. آیفون
                13 مینی به صفحه نمایشی 5.4 اینچی با رزولوشن 1080×2340 از نوع اولد و فناوری
                Super Retina XDR مجهز شده است. صفحه نمایشی که با توجه به تراکم پیکسلی
                467ppi (پیکسل در هر اینچ) توانایی ارائه کیفیت بسیار عالی وخوبی را دارد.
                Scratch-resistant ceramic glass هم از صفحه نمایش این گوشی‌هوشمند در مقابل
                ضربات و افتادن‌های احتمالی محافظت می‌کند. از طرفی این صفحه نمایش توانایی
                ارائه حداکثر روشنایی 800 نیت (شمع در متر مربع) در حالت معمولی (typical) و
                حداکثر روشنایی 1200 نیت در حالت HDR را دارد. میزان روشنایی بسیار خوب در
                نظر گرفته شده برای صفحه‌نمایش سبب شده تا در شرایط نوری متنوع و حتی زیر
                تابش مستقیم نور خورشید هم شاهد وضوح تصویر بسیار عالی و با‌کیفیتی از این
                گوشی‌هوشمند باشیم.
              </p>
              <h3>دوربین مشابه با آیفون 13</h3>
              <p>
                نه تنها سنسور‌های دوربین در نظر گرفته شده برای این گوشی‌هوشمند تفاوتی با
                مدل آیفون 13 ندارد، بلکه از سنسور‌های دوربین تقریبا مشابهی با آیفون 12
                مینی بهره برده است. اما بدون شک آیفون 13 مینی در این زمینه می‌تواند عملکرد
                بهتر و خروجی تصاویر بسیار با‌کیفیت‌تری را به نسبت آیفون 12 مینی ارائه کند.
                دلیل این اتفاق چیزی نیست جز پردازنده بسیار قدرتمند در نظر گرفته شده برای
                این گوشی‌هوشمند است. پردازنده قدرتمند، ISP یا همان پردازش تصویر
                قدرتمند‌تری را با خود به همراه دارد که تاثیر بسیار مهمی در کیفیت خروجی
                تصاویر می‌گذارد. یک سنسور دوربین اصلی با رزولوشن 12 مگاپیکسل، گشودگی دریچه
                دیافراگم f/1.6، فاصله کانونی 26 میلی متر از نوع عریض به‌همراه سنسور دوربین
                از نوع فوق عریض (ultra wide) با رزولوشن 12 مگاپیکسل، گشودگی دریچه دیافراگم
                f/2.4، زاویه دید 120 درجه و فاصله کانونی 13 میلی‌متر، سنسور‌های دوربین
                دوگانه آیفون 13 مینی را تشکیل می‌دهند. برای دوربین سلفی نیز، سنسور 12
                مگاپیکسل از نوع عریض با گشودگی دریچه دیافراگم f/2.2 در نظر گرفته شده که
                توانایی ضبط ویدیو با کیفیت 4K و نرخ 60 فریم در ثانیه را هم دارد.
              </p>
              <img src="/images/product/02.jpg" alt="" />
              <p>
                عملکرد سنسور دوربین اصلی 12 مگاپیکسلی در نور روز جای هیچ حرف و حدیثی را
                باقی نگذاشته است. داینامیک رنج بسیار جذاب، جزئیات عالی و کنتراست بسیار
                جذاب در تصاویر خروجی ثبت شده به‌خوبی دیده می‌شود. گشودگی دریچه دیافراگم هم
                جذب نور بسیار خوبی دارد و این نشان از عملکرد عالی این گوشی هوشمند در ثبت
                تصاویر شب یا در نور کم دارد. سنسور دوربین فوق عریض نیز با زاویه دید
                گسترده‌تر به نسبت سنسور دوربین اصلی، این امکان را برای شما فراهم می‌کند که
                تصاویری با زاویه دید باز و بسیار جذاب (برای مثال عکاسی در طبیعت و عکس‌های
                گروهی) به ثبت برسانید. در بخش فیلمبرداری هنوز هم گوشی‌های هوشمند اپل در
                مقایسه با بسیاری از پرچمداران اندرویدی توانایی ارائه عملکرد بهتری را دارد.
                آیفون 13 مینی نیز از این اتفاق مستثنی نیست و در کنار توانایی ضبط ویدیو با
                حداکثر کیفیت 4K‌ و نرخ 60 فریم در ثانیه، قابلیت های ویژه و جدیدی را در این
                بخش با خود به‌همراه داشته است. سنسور دوربین اصلی به قابلیت بسیار جذاب OIS
                یا همان لرزشگیر اپتیکال مجهز شده است. قابلیتی که لرزش های ناخواسته هنگام
                ضبط ویدیو را به‌خوبی حذف می‌کند و در نهایت خروجی ویدیو بسیار با‌کیفیتی را
                به شما ارائه می‌کند. همانند نسل قبلی، سنسور دوربین این گوشی نیز توانایی
                ضبط ویدیو سینماتیک را دارد که بالا‌ترین کیفیت ممکن ضبط ویدیو در میان تمام
                پرچمداران دنیا است. اما این بار اپل بهبود‌های چشم گیری را برای بخش
                فیلمبرداری این گوشی‌هوشمند در نظر گرفته تا به‌راحتی نیاز‌های یک فیلمبردار
                حرفه‌ای را نیز برطرف کند. فوکوس خودکار بسیار شگفت‌انگیز این دوربین، به لطف
                هوش مصنوعی یا همان AI، عملکرد بی‌نظیری را از خود به نمایش گذاشته است.
                فوکوس خودکار بین چهره افراد (برای مثال دو نفر در کادر دوربین حضور دارند و
                فوکوس بر روی چهره نفر جلو‌تر است، به محض اینکه نفر اول سرش با برگرداند و
                به نفر بعدی نگاه کن، دوربین به‌صورت خودکار بر روی نفر دوم فوکوس می‌کند).
              </p>
              <h3>پردازنده ای قدرتمند مشابه با آیفون 13 پرو مکس</h3>
              <img src="/images/product/01.jpg" alt="" />
              <p>
                باید قبول کنیم که تا به امروز، پردازنده‌های قدرتمند گوشی‌های هوشمند اپل در
                کنار سیستم عامل بی‌نظیر iOS توانسته اند عملکرد بسیار شگفت‌انگیزی را به
                نمایش بگذارند. این بار هم آیفون 13 مینی همانند برادران بزرگترش، یعنی آیفون
                13 پرو وآیفون 13 پرو مکس، به قدرتمند‌ترین پردازنده این شرکت یعنیُ A15
                بایونیک مجهز شده است. پردازنده ای با معماری 5 نانومتری و متشکل از 6 هسته
                (2 هسته قدرتمند‌تر به‌همراه 4 هسته با کارایی معمولی و صرفه انرژی کمتر).
                برای GPU یا همان پردازنده گرافیکی هم، پردازنده اختصاصی 4 هسته‌ای در نظر
                گرفته شده است. با توجه به نتایج بنچمارک و تست های انجام شده باید بگوییم که
                هیچ بازی در دنیا وجود ندارد که آیفون 13 مینی با بهره بردن از چنین پردازنده
                قدرتمندی، توانایی اجرا آن را نداشته باشد. البته لازم به ذکر است که این
                گوشی توانایی اجرای بازی های سنگینی همچون کال‌آ‌ف‌دیوتی موبایل و آسفالت 9
                را در بالاتری تنظیمات گرافیکی خواهد داشت. از طرفی معماری 5 نانومتری این
                پردازنده نیز سبب شده تا به‌نسبت پردازنده‌هایی با معماری 7 و 10 نانومتری
                مصرف انرژی کمتری داشته باشد و در نهایت طول عمر مفید طولانی‌تری به ازای هر
                بار شارژ 100 درصدی ارائه کند. آیفون 13 مینی در سه مدل با حافظه‌های داخلی
                128،256 و 512 گیگابایت روانه بازار شده است. در مقایسه با آیفون 12 مینی،
                همانطور که می‌بینیم دیگر خبری از حافظه داخلی 64 گیگابایتی نیست و در عوض،
                آیفون 13 به حافظه داخلی 512 گیگابایت مجهز شده است (آیفون 12 به حافظه داخلی
                512 گیگابایت مجهز نشده بود). دربخش میزان ظرفیت باتری نیز همانند هر سال،
                اپل هیچ حرفی از میزان طرفیت باتری در نظر گرفته شده برای این گوشی‌هوشمند
                چیزی نگفته است. اما به گفته اپل، آیفون 13 مینی توانایی ارائه طول عمر مفید
                بهتری به ازای هر بار شارژ 100 درصدی به‌نسبت آیفون 12 مینی دارد. حضور
        ...
        <div
          class="product-tab-content product-params tab-content border-bottom pb-2 mb-4"
              ...
              <div class="params-list">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <span class="param-value"
                      >مجهز به حس‌گر اثرانگشت , فبلت , مناسب عکاسی , مجهز به حس‌گر تشخیص
                      چهره</span
                    >
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <span class="param-value"
                      >Quad-core Cortex-A73 + Quad-core Cortex-A53 CPU</span
                    >
                  </li>
                  <li>
        ...
        <div
          class="product-tab-content product-comments tab-content border-bottom pb-2 mb-4"
          id="scrollspyHeading4"
        >
          <div class="product-tab-title mb-0">
            <h2>امتیاز و دیدگاه کاربران</h2>
            <h3 class="subtitle">
              Samsung Galaxy M31 SM-M315F/DSN Dual SIM 128GB Mobile Phone
            </h3>
          </div>
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-5 mb-3">
              <div class="ui-sticky ui-sticky-top pt-5 z-index-0">
                ...
                <div class="comments-sidebar">
                  ...
                  <div class="content-expert-rating mt-4">
                    <div class="mb-3">
                      ...
                      <div class="content-expert-rating-value-wrapper">
                        <div class="content-expert-rating-value" style="width: 90%"></div>
                  ...
                  <button class="btn btn-block btn-outline-primary">افزودن دیدگاه</button>
                </div>
            ...
            <div class="col-xl-9 col-lg-8 col-md-7 pt-5">
              ...
              <div class="filter-comments mb-4">
                ...
                <div class="filter-comments-options">
                  <button class="filter-comments-option active">
                    جدیدترین دیدگاه ها
                  </button>
              ...
              <div class="comments">
                ...
                <div class="comment">
                  ...
                  <div class="comment-body">
                    <p>
                      گوشی مناسبی هست نسبت به قیمتش من خودم با ایفون X مقایسه کردم که در
                      بعضی از برنامه ها عقب میموند بسیار گوشی خوبی هست در کل
                    </p>
                    <ul>
                      ...
                      <li class="comment-evaluation positive">
                        مناسب برای کار های حدودا سنگین و بالاتر
                      </li>
                      <li class="comment-evaluation negative">
                        حسگر اثر انگشت کمی ضعیفه
                      </li>
                    </ul>
                  </div>
        ...
        <div
          class="product-tab-content product-questions tab-content border-bottom pb-2 mb-4"
                ...
                <div class="comments-sidebar">
                  ...
                  <div class="mt-3">
                    ...
                    <button
                      ...
                      data-remodal-target="add-question-modal"
                    >
                      ثبت پرسش
                    </button>
                  </div>
              ...
              <div class="comments">
                ...
                <div class="comment question">
                  <div class="comment-body border-bottom-0">
                    <div class="question-title fw-bold">
                      سلام لطفا کسایی که خریدن جواب بدن این گوشی 4g+میشه؟مشکل آنتن دهی
                      نداره؟
                    </div>
                  </div>
                      ...
                      <div class="expandable-text_text">
                        <div class="border-bottom pb-2 mb-4">
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <p class="mb-0">
                              دوستان من ۱۰ روزه خریدم ساخت ویتنام هست و فقط 4G میشه
                            </p>
                          </div>
                          <div
                          ...
                          >
                            <div>
                              ...
                              <span class="badge badge-sm bg-info rounded-pill"
                                >خریدار</span
                              >
                            </div>
                            <div>
                        ...
                        <div class="mb-5">
                          <a
                            class="link border-bottom-0"
                            data-bs-toggle="collapse"
                            href="#collapseAnswer01"
                            role="button"
                            aria-expanded="false"
                          ...
                          <div class="rounded bg-light p-3">
                            <form action="#">
                              <div class="form-element-row mb-3">
                                <label class="label">به این پرسش پاسخ دهید*</label>
                                <textarea
                                  rows="3"
                                  class="form-control"
                ...
                <div class="comment question">
                  <div class="comment-body border-bottom-0">
                    <div class="question-title fw-bold">
                      سلام خسته نباشید m31 بهتره یا a71 ??
                    </div>
                  </div>
                  <div class="comment-footer flex-column align-items-start">
                    <div class="expandable-text pt-1 w-100" style="height: 160px">
                      <div class="expandable-text_text">
                        <div class="border-bottom pb-2 mb-4">
                          <div class="d-flex align-items-center mb-3">
                            <span class="text-sm me-4">پاسخ</span>
                            <p class="mb-0">
                              اگه به امتیازات رجوع کنید میبین که a71 در دوربین خیلی ضعیفه
                            </p>
                          </div>
                          <div
                            class="d-flex align-items-center flex-grow-1 justify-content-between w-100"
                        ...
                        <div class="mb-5">
                          <a
                            class="link border-bottom-0"
                            data-bs-toggle="collapse"
                            href="#collapseAnswer02"
                            role="button"
                            aria-expanded="false"
                            aria-controls="collapseAnswer02"
                            >ثبت پاسخ جدید <i class="ri-arrow-left-s-line"></i
                          ></a>
                        </div>
    ...
    <div
      class="remodal remodal-sm"
      data-remodal-id="notification-modal"
    ...
    <div
      class="remodal remodal-sm"
      data-remodal-id="add-question-modal"
      data-remodal-options="hashTracking: false"
    >
      <div class="remodal-header">
      ...
      <div class="remodal-content">
        ...
        <div class="fs-7 fw-bold">
          ثبت پرسش به معنی موافقت با
          <a href="#" class="link border-bottom-0">قوانین انتشار</a>
          است.
        </div>
      </div>
      <div class="remodal-footer">
    ...
    <div
      class="remodal remodal-xs"
      data-remodal-id="share-modal"
      data-remodal-options="hashTracking: false"
    >
      <div class="remodal-header">
      ...
      <div class="remodal-content">
          ...
          <div class="widget flex-grow-1 border-0 p-0 me-2">
            <div class="widget-content widget-socials">
              <ul class="align-items-center">
                ...
                <li>
                  <a href="#" class="d-inline-flex"><i class="ri-twitter-fill"></i></a>
                </li>
                <li>
                  <a href="#" class="d-inline-flex"><i class="ri-telegram-fill"></i></a>
                </li>
              </ul>
            </div>
          </div>
          <div
            class="btn btn-sm btn-primary copy-url-btn"
            data-copy="https://www.google.com"
          >
            کپی لینک
          </div>
        </div>
        ...
        <div class="d-flex justify-content-between">
          ...
          <img src="/images/theme/club.svg" width="100" alt="" />
        </div>
      </div>
    </div>
    <!-- end of share-modal -->
